...
/**
 * A generic exception used for reporting NOT_FOUND errors.
 *
 * @author lb185112
 */
...
public class ResourceDoesNotExistException extends BusinessException {
     ...
     */
    private static final String ERROR_MESSAGE = "The %1$s with the %2$s '%3$s' does not exist.";

    /**
     * The class logger.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(ResourceDoesNotExistException.class);
     ...
     */
    public ResourceDoesNotExistException(Class<? extends ResourceData> resourceClass, String value) {
